...
#no cal fer-los coincidir amb els de les classes"""
    ...
    def test_tipus_treballador_correcte(self):
        treballador = Treballador()
            #  assigngnem un de correcte
        tipus_correcte = Treballador.DIRECTOR
        treballador.set_tipus_treballador(tipus_correcte)
            # verrificació i missatge de error
        self.assertEqual(tipus_correcte, treballador.get_tipus_treballador(), "Els dos valors del tipus de treballador han de coincidir!!!")
